# Evidence Mapping Data
# Migrated from frontend/src/services/evidenceMapping.ts
...
def get_evidence_mapping(concept: str) -> dict | None:
    """Get evidence mapping for a concept."""
    normalized = concept.lower().strip()
    
    # Direct match
    if normalized in EVIDENCE_MAPPINGS:
        return EVIDENCE_MAPPINGS[normalized]
    
    # Partial match
    for key, mapping in EVIDENCE_MAPPINGS.items():
